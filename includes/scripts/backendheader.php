...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 topmenu_left">
...
<div class="container-fluid menu_block2">
    ...
    <div class="menu_block2_link">
        ...
        <a href="javascript:void(0)"> Send Message</a>
         <a href="javascript:void(0)">Review activities</a>
             <a href="javascript:void(0)">Help request</a>
                 <a href="javascript:void(0)">Review Documents</a>
